...
<style>
*{box-sizing:border-box}body{margin:0;font-family:Pretendard,"Noto Sans KR",Arial,sans-serif;background:#eef5f8;color:#25384a;font-size:13px}a{text-decoration:none;color:inherit}.layout{display:grid;grid-template-columns:228px minmax(0,1fr);min-height:100vh}.main{padding:28px}.card{background:#fff;border:1px solid #d8e2e7;padding:18px}.top{display:flex;justify-content:space-between;gap:16px;align-items:center;margin-bottom:16px}.top h1{font-size:20px;margin:0}.top p{margin:5px 0 0;color:#84949e}.top-stats{display:flex;gap:7px;flex-wrap:wrap;justify-content:flex-end}.stat{display:inline-flex;align-items:center;gap:5px;height:32px;padding:0 10px;background:#f7f9fb;border:1px solid #e0e6ea;border-radius:5px;color:#667a88;font-size:12px}.stat b{color:#3924b9;font-size:13px}.stat.alert{background:#fff7f4;border-color:#f2d4ca}.stat.alert b{color:#e3472f}
.filter-box{margin-bottom:14px;padding:14px;background:#f7f9fb;border:1px solid #e0e6ea}.filter-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px}.filter-item{min-width:0}.filter-item.search{grid-column:span 2}.filter-label{display:block;margin:0 0 6px;color:#657986;font-size:11px;font-weight:700}.filter-control{display:flex;gap:7px;align-items:center;min-width:0}.filter-control input[type=date],.filter-control input[type=search],.filter-control select{width:100%;height:36px;border:1px solid #c7d2d9;border-radius:4px;padding:0 9px;background:#fff;color:#334957}.filter-control input[type=search]{min-width:0}.radio-group{display:flex;gap:10px;align-items:center;height:36px;flex-wrap:wrap}.radio{display:inline-flex;align-items:center;gap:4px;white-space:nowrap}.search-actions{display:flex;justify-content:flex-end;align-items:flex-end;gap:7px}.btn{display:inline-flex;align-items:center;justify-content:center;height:36px;padding:0 14px;border:1px solid #cfd9df;border-radius:4px;background:#fff;color:#425969;font-weight:700;cursor:pointer}.btn.primary{background:#3924b9;border-color:#3924b9;color:#fff}.btn.danger{background:#fff;color:#d74735;border-color:#e5aaa3}.btn.small{height:29px;padding:0 9px;font-size:12px}
.result-bar{display:flex;justify-content:space-between;align-items:center;margin-bottom:10px;padding:10px 12px;background:#f7f9fb;border:1px solid #e0e6ea}.result-count{font-size:13px;font-weight:700}.result-count .pending{color:#e4432f}.result-count .searched{color:#3924b9}.result-tools{display:flex;gap:6px;align-items:center}.result-tools select{height:32px;border:1px solid #c7d2d9;border-radius:4px;padding:0 8px;background:#fff}
.table-wrap{overflow-x:auto;border:1px solid #e0e6ea}.inquiry-table{width:100%;border-collapse:collapse;table-layout:fixed;min-width:1120px}.inquiry-table th,.inquiry-table td{padding:11px 9px;border-bottom:1px solid #e2e8ec;text-align:center;vertical-align:middle}.inquiry-table th{background:#f7f9fb;color:#536b77;font-size:12px}.inquiry-table tbody tr.data-row:nth-of-type(odd){background:#fbfcfd}.inquiry-table tbody tr.data-row:hover{background:#f7f9ff}.col-check{width:42px}.col-status{width:92px}.col-no{width:205px}.col-writer{width:120px}.col-date{width:150px}.col-answer{width:135px}.inquiry-no{display:block;max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#536977;font-size:12px;font-variant-numeric:tabular-nums}.subject{text-align:left!important}.subject a{display:block;color:#2157c7;font-weight:700;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.subject small{display:block;color:#8a9aa5;margin-top:4px;font-weight:400;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.state{display:inline-flex;align-items:center;justify-content:center;min-width:62px;height:24px;padding:0 8px;border-radius:999px;font-size:11px;font-weight:800}.state.new{background:#fff0ea;color:#e6572e}.state.answered{background:#eaf7ee;color:#357249}.answer-link{display:inline-flex;align-items:center;justify-content:center;min-width:82px;height:28px;padding:0 10px;border-radius:5px;font-weight:700;white-space:nowrap}.answer-link.pending{color:#3924b9;background:#f0edff;border:1px solid #d8d0ff}.answer-link.done{color:#357249;background:#edf8f0;border:1px solid #d4ecd9}.answer-link.opened{color:#5e6f79;background:#f4f6f8;border:1px solid #dbe2e6}
.detail-row td{padding:0!important;background:#fbfcfd}.detail-box{display:grid;grid-template-columns:minmax(0,1fr) minmax(360px,.9fr);text-align:left;border-top:2px solid #ded8ff}.question-box,.reply-box{padding:18px 20px}.question-box{border-right:1px solid #e5ecef}.detail-title{font-weight:800;margin-bottom:10px;color:#314858}.detail-message{white-space:pre-wrap;line-height:1.7;color:#334956}.reply-box textarea{width:100%;min-height:120px;padding:11px;border:1px solid #ccd8df;border-radius:6px;resize:vertical;font:inherit;line-height:1.6}.reply-foot{display:flex;justify-content:space-between;align-items:center;margin-top:9px;gap:10px}.reply-note{font-size:11px;color:#8b9ba5}.reply-actions{display:flex;gap:6px}.bulk-bar{display:flex;justify-content:space-between;align-items:center;padding:11px 12px;border:1px solid #e0e6ea;border-top:0;background:#f7f9fb}.bulk-left{display:flex;align-items:center;gap:7px}.bulk-left select{height:32px;border:1px solid #cfd9df;border-radius:4px;padding:0 8px}.pagination{display:flex;justify-content:center;align-items:center;gap:4px;padding:17px}.page-link{min-width:30px;height:30px;display:inline-flex;align-items:center;justify-content:center;border:1px solid #d6e0e5;border-radius:4px;color:#617582;background:#fff}.page-link.active{background:#3924b9;color:#fff;border-color:#3924b9}.empty{padding:45px!important;color:#8797a1}.notice{margin-bottom:12px;padding:11px 13px;border-radius:5px;background:#eaf7ee;color:#36744b;border:1px solid #cfe9d7}.notice.error{background:#fff1ed;color:#bd4933;border-color:#f1cdc5}
@media(max-width:1100px){.filter-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.filter-item.search{grid-column:span 1}}@media(max-width:850px){.layout{grid-template-columns:1fr}.admin-sidebar{display:none}.main{padding:12px}.top{align-items:flex-start;flex-direction:column}.top-stats{justify-content:flex-start}.filter-grid{grid-template-columns:1fr}.search-actions{justify-content:flex-start}.detail-box{grid-template-columns:1fr}.question-box{border-right:0;border-bottom:1px solid #e5ecef}}
</style>
...
<form class="filter-box" method="get"><div class="filter-grid">
    <div class="filter-item"><span class="filter-label">조회기간</span><div class="filter-control"><input type="date" name="from" value="<?=h($from)?>"><span>~</span><input type="date" name="to" value="<?=h($to)?>"></div></div>
    ...
    <div class="filter-item search"><span class="filter-label">검색어</span><div class="filter-control"><input type="search" name="q" value="<?=h($q)?>" placeholder="문의번호 / 고객명 / 연락처 / 이메일 / 문의내용"></div></div>
    <input type="hidden" name="per_page" value="<?=$perPage?>">
    <div class="search-actions"><button class="btn primary" type="submit">검색</button><a class="btn" href="./inquiries.php">초기화</a></div>
</div></form>
...
<div class="table-wrap"><table class="inquiry-table"><thead><tr><th class="col-check"><input type="checkbox" id="checkAll"></th><th class="col-status">처리상태</th><th class="col-no">문의번호</th><th>문의내용</th><th class="col-writer">작성자</th><th class="col-date">등록일</th><th class="col-answer">답변 관리</th></tr></thead><tbody>
<?php if(!$rows):?><tr><td colspan="7" class="empty">조건에 맞는 문의가 없습니다.</td></tr><?php endif;?>
<?php foreach($rows as $r): $isOpen = $openId === (int)$r['id']; ?>
<tr class="data-row">
...
<td><span class="inquiry-no" title="<?=h($r['inquiry_no'])?>"><?=h($r['inquiry_no'])?></span></td>
<td class="subject"><a href="?<?=h(qstr(['open'=>$isOpen ? null : (int)$r['id']]))?><?=$isOpen ? '' : '#inquiry-'.(int)$r['id']?>"><?=h(mb_strimwidth(preg_replace('/\s+/', ' ', (string)$r['message']),0,90,'…','UTF-8'))?></a><small><?=h($r['member_phone'] ?: ($r['member_email'] ?: '연락처 없음'))?></small></td>
<td><?=h($r['member_name'] ?: '비회원')?></td>
<td><?=h(date('Y-m-d H:i', strtotime((string)$r['created_at'])))?></td>
<td><a class="answer-link <?=$isOpen?'opened':($r['status']==='ANSWERED'?'done':'pending')?>" href="?<?=h(qstr(['open'=>$isOpen ? null : (int)$r['id']]))?><?=$isOpen ? '' : '#inquiry-'.(int)$r['id']?>"><?=$isOpen?'접기':($r['status']==='ANSWERED'?'답변 확인·수정':'답변하기')?></a></td>
</tr>
<?php if($isOpen):?>
<tr class="detail-row" id="inquiry-<?= (int)$r['id'] ?>"><td colspan="7"><div class="detail-box"><div class="question-box"><div class="detail-title">문의 내용</div><div class="detail-message"><?=h($r['message'])?></div><div class="reply-note" style="margin-top:12px">고객: <?=h($r['member_name'] ?: '비회원')?><?php if($r['member_phone']):?> · <?=h($r['member_phone'])?><?php endif;?><?php if($r['member_email']):?> · <?=h($r['member_email'])?><?php endif;?></div></div><div class="reply-box"><div class="detail-title">관리자 답변</div><textarea form="replyForm<?=$r['id']?>" name="answer" maxlength="3000" required placeholder="고객에게 전달할 답변을 입력해 주세요."><?=h($r['answer'] ?? '')?></textarea><form id="replyForm<?=$r['id']?>" action="./inquiry-actions.php" method="post"><input type="hidden" name="id" value="<?= (int)$r['id'] ?>"><input type="hidden" name="action" value="save_answer"><input type="hidden" name="return_query" value="<?=h(qstr(['open'=>(int)$r['id']]))?>"></form><div class="reply-foot"><span class="reply-note"><?php if($r['answered_at']):?>마지막 답변 <?=h($r['answered_at'])?><?php if($r['answered_admin_name'] || $r['answered_admin_username']):?> · <?=h($r['answered_admin_name'] ?: $r['answered_admin_username'])?><?php endif;?><?php else:?>답변 등록 시 사용자 문의 내역에 반영됩니다.<?php endif;?></span><div class="reply-actions"><a class="btn small" href="?<?=h(qstr(['open'=>null]))?>">닫기</a><button class="btn primary small" type="submit" form="replyForm<?=$r['id']?>"><?=$r['answer']?'답변 수정':'답변 등록'?></button></div></div></div></div></td></tr>
<?php endif;?>
