                        ...
                        <?php else: ?>
                            <?php foreach ($vehicleRows as $row): ?>
                                <tr>
                                    ...
                                    <td><?php if (!empty($row['image_path'])): ?><a class="product-thumb-link" href="./vehicles.php?<?= h(adminQuery(['vehicle_id' => (int)$row['id']])) ?>#vehicle-detail" aria-label="<?= h($row['name']) ?> 상세 보기"><img class="product-thumb" src="../<?= h($row['image_path']) ?>" alt="<?= h($row['name']) ?>"></a><?php else: ?><span class="no-thumb">No image</span><?php endif; ?></td>
                                    <td>
                                        <?= (int)$row['is_active'] === 1
